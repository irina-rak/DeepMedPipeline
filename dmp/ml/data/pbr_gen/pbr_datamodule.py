import sys
sys.path.append("/home/irinar/Documents/projects/DeepMedPipeline")
...
from dmp.ml.data.pbr_gen.pbr_dataset import CTCacheDataset
...
def get_transforms_ldm(
    ...
    common_preprocessing = [
        ...
        #     keys=["image"],
        #     spatial_size=patch_size,
        #     mode="constant",  # padding mode when volume is smaller
        #     constant_values=0,
...
class PBRLitDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if stage == "test" or stage is None:
            ...
            # self.data_test = DecathlonDataset(
            #     root_dir=self.data_dir_test,
            #     task="Task01_BrainTumour",
            #     section="testing",
            #     cache_rate=self.cache_rate,
            #     num_workers=self.num_workers,
